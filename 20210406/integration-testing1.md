In this mini series I will go through some challenges and solutions I applied in implementing integration testing with EF Core and Sql Server running on Docker.
